...
- **rasi**: owner will return surely the Planet not None

## v0.27.0 (2026-05-27)

### Feat

- **core**: Add functionality to calculate rise and set times for physical planets

## v0.26.0 (2026-05-24)

### Refactor

- **ayanamsa**: Rename `lahiri_traditional` to `true_lahiri` for clarity and consistency
